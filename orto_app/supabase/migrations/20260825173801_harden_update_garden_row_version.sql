...
-- Rimuove la firma precedente priva del controllo ottimistico
-- expected_row_version, evitando overload paralleli della stessa RPC.
drop function public.update_garden(
  uuid,
  uuid,
  uuid,
  uuid,
...
begin
  ...
  -- --------------------------------------------------------------------------
  -- Il client può aggiornare soltanto la versione che ha effettivamente letto.
  -- In caso di conflitto non viene modificato alcun dato.
  ...
  -- --------------------------------------------------------------------------
  -- 6. VALIDAZIONE INPUT OBBLIGATORI
  -- --------------------------------------------------------------------------
  ...
  -- --------------------------------------------------------------------------
  -- 8. VALIDAZIONE ISO 3166-1 ALPHA-2
  -- --------------------------------------------------------------------------
